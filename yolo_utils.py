...
def decode(output , height , width , intersec_over_union):
    
    boxes , scores = decode_to_boxes(output, height, width)
    boxes = non_max(boxes, np.array(scores), intersec_over_union)
    return boxes
