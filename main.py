...
def run_yolo(blank_img, answer_img, submissions_img, display_blank_img=False, display_answer_img=False, display_submis_img=False):
...
blank_text_boxes, answer_text_boxes, submissions_text_boxes = run_yolo(blank_img, answer_img, sumbissions_img, display_blank_img=True, display_answer_img=True, display_submis_img=False)
